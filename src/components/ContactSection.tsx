...
export default function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="relative w-full min-h-screen bg-surface overflow-hidden flex flex-col"
    >
      ...
      <div className="relative z-10 flex-1 flex items-center justify-between px-8 md:px-12 lg:px-16 pt-20">
        ...
        <div className="max-w-sm flex flex-col gap-6">
          ...
          <div>
            ...
            <p className="text-[10px] text-accent tracking-[0.2em] uppercase font-bold">
              Software Developer
            </p>
          </div>
          ...
          <div className="flex items-center gap-5 text-white/60">
            <a href="https://github.com/beingsv" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-[10px] tracking-wider uppercase hover:text-accent transition-colors">
            ...
            <a href="https://www.linkedin.com/in/beingsv/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-[10px] tracking-wider uppercase hover:text-accent transition-colors">
              <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
              LinkedIn
            </a>
            <a href="https://www.instagram.com/im.blacksmith/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-[10px] tracking-wider uppercase hover:text-accent transition-colors">
        ...
        <div className="hidden lg:block max-w-md text-right">
          ...
          <Magnetic className="w-full">
            <a
              href="mailto:beingsamvis@gmail.com"
              className="inline-flex items-center justify-center gap-2 w-full px-8 py-4 border border-accent text-accent text-xs font-bold tracking-[0.2em] uppercase rounded-full hover:bg-accent hover:text-white transition-all duration-300"
            >
              Let&apos;s Talk →
            </a>
          </Magnetic>
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 hidden md:flex items-center justify-center pointer-events-none">
        {/* Glowing orb */}
        <div className="absolute w-32 h-32 rounded-full bg-accent/30 blur-2xl animate-glow-pulse" />
        <div
          className="absolute w-4 h-4 rounded-full bg-accent animate-glow-pulse"
          style={{
            boxShadow:
              "0 0 25px 10px color-mix(in oklab, var(--accent) 60%, transparent)",
          }}
        />
